...
$(document).ready(function(){
    $("#DepartmentAdminAddForm").validationEngine();
    });
</script>
<div class="control-group">
	<div class="page-header position-relative">
                <h1>Admin <small><i class="icon-double-angle-right"></i> Add Department</small></h1>
        </div>
    
        <div class="widget-box">
            <div class="widget-header widget-header-blue widget-header-flat">
                    <h4 class="lighter">Add New Department</h4>
                </div>
        <div class="widget-body">
             <div class="widget-main">
                <div class="row-fluid">

<?php echo $this->Form->create('Department', array('url' => array('prefix' => 'admin', 'admin' => true, 'controller' => 'departments', 'action' => 'add', $clientId)));?>
	<?php
