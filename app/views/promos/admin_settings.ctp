            ...
            if(count($exp_categories) > 0){ 
              foreach($exp_categories as $key=>$categories){
                ...
                if($key == (count($exp_categories) -1)){ ?>
                    <a class="btn-mini btn-info" href="javascript:void(0);"  onClick="add_location(<?php echo $key; ?>)">Add More</a>
                <?php } else { ?>
                    <a style="display:none;" class="btn-mini btn-info" href="javascript:void(0);"  onClick="add_location(<?php echo $key; ?>)">Add More</a>
                <?php } 
                if($key != 0){?>
                    <a class="btn-mini btn-danger" href="javascript:void(0);"  onClick="delete_location(<?php echo $key; ?>)">Delete</a>
                <?php } ?>
            ...
            if(count($ota_categories) > 0){ 
              foreach($ota_categories as $key=>$categories){
                ...
                if($key == (count($ota_categories) -1)){ ?>
                    <a class="btn-mini btn-info" href="javascript:void(0);"  onClick="add_category(<?php echo $key; ?>)">Add More</a>
                <?php } else { ?>
                    <a style="display:none;" class="btn-mini btn-info" href="javascript:void(0);"  onClick="add_category(<?php echo $key; ?>)">Add More</a>
                <?php } 
                if($key != 0){?>
                    <a class="btn-mini btn-danger" href="javascript:void(0);"  onClick="delete_category(<?php echo $key; ?>)">Delete</a>
                <?php } ?>
