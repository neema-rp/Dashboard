    ...
    <div id="sheetinfo" style="text-align:center;">
            ...
            <div id="chart-menu">
               <?php
                ...
                if(($this->params['prefix'] == 'client') && ($sheet['Sheet']['import_oceanview'] == 1)){                    
                    echo $this->Html->link('Import CSV', array('prefix' => 'client', 'client' => true, 'controller' => 'sheets', 'action' => 'import_oceanview' ,$sheetId), array('class' => 'btn btn-warning btn-mini','style'=>'margin-bottom:4px;'));
                }
                if(($this->params['prefix'] == 'client') && ($sheet['Sheet']['import_sanbona'] == 1)){                    
                    echo $this->Html->link('Import CSV', array('prefix' => 'client', 'client' => true, 'controller' => 'sheets', 'action' => 'import_sanbona' ,$sheetId), array('class' => 'btn btn-warning btn-mini','style'=>'margin-bottom:4px;'));
                }
                ?>
            </div>
            <div class="clear"></div>
