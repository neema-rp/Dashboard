...
$(document).ready(function(){
    $("#ColumnStaffAddForm").validationEngine();
});
</script>
<div class="control-group">
	<div class="page-header position-relative">
                <h1>Staff Add Column Range for Hotel <small><i class="icon-double-angle-right"></i> <?php echo $hotelname;  ?></small></h1>
        </div>
        ...
        //echo "&nbsp;&nbsp;";
        //echo $this->Html->link('Cancel', array('prefix' => 'Staff', 'Staff' => true, 'controller' => 'clients', 'action' => 'index'), array('class' => 'btn btn-success', 'escape' => false));
        echo $this->Form->end();
        ?>
</div>