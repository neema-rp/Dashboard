	...
	<div class="page-header position-relative">
        ...
        <div class="widget-box">
            <div class="widget-header widget-header-blue widget-header-flat">
                    <h4 class="lighter">Add MarketSegment</h4>
                </div>
                <div class="widget-body">
                     <div class="widget-main">
                        <div class="row-fluid">
                        <?php echo $this->Form->create('MarketSegment');
                        echo $this->Form->input('name',array('id'=>'name','class'=>'validate[required] span6','placeholder'=>'MarketSegment Name','label'=>array('class'=>'control-label'),'div'=>array('class'=>'control-group')));
