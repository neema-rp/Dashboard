...
<div class="control-group">
	<div class="page-header position-relative">
                <h1>Admin <small><i class="icon-double-angle-right"></i> Add MarketSegment</small></h1>
        </div>
            ...
            <div class="widget-header widget-header-blue widget-header-flat">
                ...
                <div class="widget-body">
                     <div class="widget-main">
                        <div class="row-fluid">
                            <?php echo $this->Form->create('MarketSegment', array('url' => array('prefix' => 'admin', 'admin' => true, 'controller' => 'MarketSegments', 'action' => 'list')));
                            ...
                            echo "&nbsp;&nbsp;";
                            echo $this->Html->link('Cancel', array('prefix' => 'admin', 'admin' => true, 'controller' => 'clients', 'action' => 'land',$client_id), array('class' => 'btn btn-success', 'escape' => false));
                            echo $this->Form->end();                
                            ?>
                        </div>
                     </div>
