...
<div class="control-group">
	<div class="page-header position-relative">
                <h1>Admin <small><i class="icon-double-angle-right"></i> Add Question</small></h1>
        </div>
	...
	?>
            ...
            <select  name="data[SurveyQuestion][type]" class="validate[required] span6">
                ...
                echo "&nbsp;&nbsp;";
                echo $this->Html->link('Cancel', array('prefix' => 'admin', 'admin' => true, 'controller' => 'SurveyQuestions', 'action' => 'index',$client_id), array('class' => 'btn btn-success', 'escape' => false));
                echo $this->Form->end();
                ?>
