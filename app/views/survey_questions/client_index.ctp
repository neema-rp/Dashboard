...
<div class="control-group">
	...
	<?php echo $this->Form->create('SurveyQuestion', array('url'=>array('controller'=>'SurveyQuestions', 'action'=>'client_index',$client_id)));?>
		...
		<tbody>
			<tr>
				...
				<td>
				  	<?php echo $this->Html->link('Clear', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyQuestions', 'action' => 'index',$client_id), array('escape' => false,'class'=>'btn btn-info')); ?>
				</td>
				<td>&nbsp;</td>
				<td>
				    <div style="float:left;">
                                        <?php //echo $this->Html->link('Guests', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyUsers', 'action' => 'index',$client_id), array('escape' => false,'class'=>'btn btn-info')); ?>
					<?php echo $this->Html->link('Add Question', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyQuestions', 'action' => 'add',$client_id), array('escape' => false,'class'=>'btn btn-info')); ?>
				    </div>
				</td>
			</tr>
		</tbody>
