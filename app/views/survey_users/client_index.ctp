...
<div class="control-group">
            ...
            <tr>
               	<td>
                    <?php if($access_survey == '0'){
                        echo $this->Html->link('View Guest completed Survey', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyUsers', 'action' => 'index',$client_id,'1'), array('escape' => false,'class'=>'btn btn-info'));
                    }else{
                        echo $this->Html->link('View Guest', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyUsers', 'action' => 'index',$client_id,'0'), array('escape' => false,'class'=>'btn btn-info'));
                    }?>

                    <a href="/SurveyUsers/view_survey/<?php echo $client_id; ?>" class="btn btn-info" target="_blank">View Survey Sample</a>  
                    &nbsp;&nbsp;&nbsp;<?php
                    //echo $this->Html->link('Survey Questions', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyQuestions', 'action' => 'index',$client_id), array('escape' => false,'class'=>'btn btn-info'));
                    ?>
                    &nbsp;&nbsp;&nbsp;<?php
	...
	<?php echo $this->Form->create('SurveyUser', array('url'=>array('controller'=>'SurveyUsers', 'action'=>'client_index',$client_id,$access_survey)));?>
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tbody>
			<tr>
				<?php
					...
					search by name, email
                                ...
                                <td>
				  	<?php echo $this->Html->link('Clear', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyUsers', 'action' => 'index',$client_id), array('escape' => false,'class'=>'btn btn-info')); ?>
				</td>
				<td>&nbsp;</td>
                                <td>
				    <div style="float:left;">
					<?php echo $this->Html->link('Add Guest', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyUsers', 'action' => 'add',$client_id), array('escape' => false,'class'=>'btn btn-info')); ?>
				    </div>
				</td>
			</tr>
		</tbody>
