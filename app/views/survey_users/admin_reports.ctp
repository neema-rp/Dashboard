		...
		<div align="right">
                    ...
                    <tr>
                        ...
                        <td style="float:right">
                            <?php echo $this->Html->link('View Guest', array('prefix' => 'admin', 'admin' => true, 'controller' => 'SurveyUsers', 'action' => 'index',$client_id,'0'), array('escape' => false,'class'=>'btn btn-info')); ?>
                        </td>
                    </tr>
                    <tr>
