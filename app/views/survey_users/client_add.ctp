...
<div class="control-group">
	<div class="page-header position-relative">
                <h1>client <small><i class="icon-double-angle-right"></i> Add Guest</small></h1>
        </div>
	...
	<?php
		...
		echo $this->Form->input('email',array('id','email','class'=>'span6','placeholder'=>'Email','label'=>array('class'=>'control-label'),'div'=>array('class'=>'control-group')));
                ...
                echo "&nbsp;&nbsp;";
                echo $this->Html->link('Cancel', array('prefix' => 'client', 'client' => true, 'controller' => 'SurveyUsers', 'action' => 'index',$client_id), array('class' => 'btn btn-success', 'escape' => false));
                echo $this->Form->end();
                ?>
