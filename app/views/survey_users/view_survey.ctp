					...
					<div class="span4 offset2">
						<fieldset>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span4" name="name" id="name" style="margin-bottom:1em;" value="Duncan Bramwell" disabled="disabled">
								</div>
							</div>
						</fieldset>
					</div>
					<div class="span4">
						<fieldset>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span4" name="eml" id="eml" style="margin-bottom:1em;" value="duncan.bramwell@revenue-performance.com" disabled="disabled">
								</div>
							</div>
						</fieldset>
					</div>
						...
						<div class="span8 offset2" style="border-bottom:1px dashed #ccc;margin-bottom:0.75em;"></div>        
                            ...
                            <div class="gf_likert span8 offset2">
                                                    ...
                                                    <?php for($i=1;$i<=10;$i++){ ?>
                                                        <td class="gchoice_2_<?php echo $i; ?>">
                                                            <div class="inline_div">
                                                                <input name="check" type="radio" value="<?php echo $i; ?>" id="choice_2_<?php echo $i; ?>" tabindex="6" onclick="gf_apply_rules(3,[6]);" class="likert-choice" />
                                ...
                                <?php }else{ ?>
                                    <div class="controls">
                                            <textarea class="span8" name="GM_GuestComm" id="GM_GuestComm" rows="5"></textarea><div class="charleft originalDisplayInfo" style="width: 756px;">1500 Characters Left</div>
                                    </div>
                                <?php } ?>                                
                            </div>
                       </div>
...
<!--				<div class="row" style="direction:ltr;">
					...
					<div class="span8 offset2">
						...
						<div id="primaryreason" style="direction:ltr; margin-bottom:1.5em;">
							Reason for your stay? 
							<select name="GM_PrimaryReason_ID">
								<option value="0">Select...</option>
								
								<option value="143">Business</option>
								
								<option value="144">Leisure/Holiday</option>
								
								<option value="145">Conference</option>
...
<!--				<div class="row" style="direction:ltr; margin-bottom:2em;">
					
					<div class="span8 offset2">
						We are constantly striving to be more socially and environmentally responsible.  Please give us suggestions on changes you would like to see in this regard.
					</div>
				</div>-->
