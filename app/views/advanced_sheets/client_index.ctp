...
<div class="control-group">
	...
	<?php echo $this->Form->create('AdvancedSheet', array('url' => array('prefix' => 'client', 'client' => true, 'controller' => 'AdvancedSheets', 'action' => 'index', $userId,$dept_id))); ?>
		...
		<tbody>
			<tr>
				...
				<td class="AdvancedSheetIndex buttonscol">
					<?php echo $this->Html->link('Clear', array('prefix' => 'client', 'client' => true, 'controller' => 'AdvancedSheets', 'action' => 'index', $userId, $dept_id), array('escape' => false,'class'=>'btn btn-info')); ?>
				</td>
				<td>&nbsp;</td>
				<td>
					<?php //echo $this->Html->link('Add Segmentation Sheet', array('prefix' => 'client', 'client' => true, 'controller' => 'Templates', 'action' => 'create_advance', $userId, $this->params['pass'][1]), array('escape' => false,'class'=>'btn btn-info')); ?>
                                </td>
                                <td>
					<?php //echo $this->Html->link('Create Multiple Segmentation', array('prefix' => 'client', 'client' => true, 'controller' => 'Templates', 'action' => 'copyAdvancedSheet', $this->params['pass'][0], $last_AdvancedSheet['AdvancedSheet']['id'],$dept_id), array('escape' => false,'class'=>'btn btn-info')); ?>
                                </td>
			</tr>
		</tbody>
	</table>
...
$j++;
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php 
			  echo $this->Html->link(__('<i class="icon-qrcode bigger-130"></i>', true), array('prefix' => 'client', 'client' => true, 'action' => 'webform', $AdvancedSheet['AdvancedSheet']['id']), array('title' => 'Sheets', 'escape' => false,'class'=>'blue'));                           
                	?>
		</td>
	</tr>
<?php } endforeach; }else{ ?>
