...
<div class="sheets index">
        <?php echo $this->Form->create('Sheet', array('url'=>array('controller'=>'webservices', 'action'=>'admin_import_operaexcel/'.$sheetId),'type' => 'file'));?>
        <fieldset>
        <legend><?php __('Import Opera excl Comps');?></legend>
