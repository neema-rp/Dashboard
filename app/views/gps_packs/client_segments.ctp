...
<?php echo $this->Form->create('GpsPack', array('url' => array('prefix' => 'client', 'client' => true, 'controller' => 'GpsPacks', 'action' => 'segments')));?>
...
echo $this->Form->end();
echo '&nbsp;&nbsp;&nbsp;&nbsp;';
echo $this->Html->link('Cancel', array('prefix' => 'client', 'client' => true, 'controller' => 'GpsPacks', 'action' => 'index',$GpsPack['GpsPack']['client_id']), array('class' => 'btn btn-warning', 'escape' => false));?>
</div>
</div>