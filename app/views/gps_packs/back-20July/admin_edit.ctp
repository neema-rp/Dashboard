...
?>
<?php echo $this->Form->create('GpsPack', array('url' => array('prefix' => 'admin', 'admin' => true, 'controller' => 'GpsPacks', 'action' => 'edit')));?>
	...
	<fieldset>
 		<legend><?php __('Edit GPS Pack'); ?></legend>
                ...
                <?php if($step=='1'){ 
                    ...
                    if(empty($step1Data)){
                        header('Location: /admin/GpsPacks/add/1/'.$gps_pack_id);
                    }
 		...
 		<legend><?php __('GM Summary'); ?></legend>
                ...
                <?php }elseif($step=='2'){ 
                    ...
                    if(empty($step2Data)){
                        header('Location: /admin/GpsPacks/add/2/'.$gps_pack_id);
                    }
                ?>
                <fieldset>
 		<legend><?php __('Summary'); ?></legend>
                ...
                <?php }elseif($step=='3'){ 
                    ...
                    if(empty($step3Data)){
                        header('Location: /admin/GpsPacks/add/3/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Market'); ?></legend>
                ...
                <?php }elseif($step=='4'){ 
                    ...
                    if(empty($step4Data)){
                        header('Location: /admin/GpsPacks/add/4/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Competition'); ?></legend>
                ...
                <?php }elseif($step=='5'){ 
                    ...
                    if(empty($step5Data)){
                        header('Location: /admin/GpsPacks/add/5/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Activity'); ?>&nbsp;<?php echo date("F", mktime(0, 0, 0, $gps_month, 1));  ?></legend>
                ...
                <?php }elseif($step=='6'){ 
                    ...
                    if(empty($step6Data)){
                        header('Location: /admin/GpsPacks/add/6/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Activity '); ?><?php echo date("F", mktime(0, 0, 0, ($gps_month+1), 1));  ?></legend>
                ...
                <?php }elseif($step=='7'){ 
                    ...
                    if(empty($step7Data)){
                        header('Location: /admin/GpsPacks/add/7/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Activity '); ?><?php echo date("F", mktime(0, 0, 0, ($gps_month+2), 1));  ?></legend>
                ...
                <?php }elseif($step=='8'){ 
                    ...
                    if(empty($step8Data)){
                        header('Location: /admin/GpsPacks/add/8/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Activity '); ?><?php echo date("F", mktime(0, 0, 0, ($gps_month+3), 1));  ?></legend>
                ...
                <?php }elseif($step=='9'){ 
                    ...
                    if(empty($step9Data)){
                        header('Location: /admin/GpsPacks/add/9/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		...
 		<legend><?php __('BOB - '); ?><?php echo date("F", mktime(0, 0, 0, ($gps_month+3), 1));  ?></legend>
                ...
                <?php }elseif($step=='14'){ 
                    ...
                    if(empty($step14Data)){
                        header('Location: /admin/GpsPacks/add/14/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Channels - '); ?><?php echo date("F", mktime(0, 0, 0, $gps_month, 1));  ?></legend>
                ...
                <?php }elseif($step=='15'){ 
                    ...
                    if(empty($step15Data)){
                        header('Location: /admin/GpsPacks/add/15/'.$gps_pack_id);
                    }
 		...
 		<legend><?php __('Channels Year'); ?></legend>
                ...
                <?php }elseif($step=='16'){ 
                    ...
                    if(empty($step16Data)){
                        header('Location: /admin/GpsPacks/add/16/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Geo Year'); ?></legend>
                ...
                <?php }elseif($step=='17'){ 
                    ...
                    if(empty($step17Data)){
                        header('Location: /admin/GpsPacks/add/17/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Prov Year'); ?></legend>
                ...
                <?php }elseif($step=='18'){ 
                    ...
                    if(empty($step18Data)){
                        header('Location: /admin/GpsPacks/add/18/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		...
 		<legend><?php __('Room Type Year'); ?></legend>
                ...
                <?php }elseif($step=='20'){
                    ...
                    if(empty($step20Data)){
                        header('Location: /admin/GpsPacks/add/20/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Future Activity'); ?></legend>
                ...
                <?php }elseif($step=='21'){
                    ...
                    if(empty($step21Data)){
                        header('Location: /admin/GpsPacks/add/21/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
...
//                        $reputation_arr['Tres Booking Funnel'][] = 'Bookings';
                               ...
                               foreach($step21Data as $step21_key=>$step21_val){
                                   if(($step21_val['GpsData']['text'] == $reputation_key) && ($step21_val['GpsData']['sub_text'] == $rep_val) && ($step21_val['GpsData']['question'] == ($cnt + ($loop_count*12)))){
                                       ...
                                       if($rep_val == 'Ranking'){
                                            ...
                                            echo $this->Form->input('value[]',array('type'=>'text','value'=>$step21_val['GpsData']['value'],'label'=>false,'name'=>'data[GpsPack][value][]','id'=>$field_id.$month.$reputation_count,'data-month'=>$month,'class'=>$field_id,'data-reputation'=>$reputation_count));
                                       }
              ...
              <?php }elseif($step=='22'){ 
                  ...
                  if(empty($step22Data)){
                        header('Location: /admin/GpsPacks/add/22/'.$gps_pack_id);
                    }
                  ?>
                <fieldset>
...
<script>
    $(document).ready(function(){
        ...
        $('.RevExc').css({'background-color' : '#BDBDBD'});
            ...
            $(".RevInc").keyup(function () {
                ...
                $('#RevExc'+month+reputation_count).val(exc_val);
            });
    });
</script>