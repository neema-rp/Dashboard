                            ...
                            <tr>
                                ...
                                if(!empty($step21Data)){
                                       ...
                                       if($rep_val == 'Ranking'){
                                            ...
                                            echo $this->Form->input('value[]',array('type'=>'text','label'=>false,'name'=>'data[GpsPack][value][]','id'=>$field_id.$month.$reputation_count,'data-month'=>$month,'class'=>$field_id,'data-reputation'=>$reputation_count));
                                       }
                                }
                                ?></td>
