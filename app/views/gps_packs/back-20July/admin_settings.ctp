...
<!--        <div class="input">
		<label for="GpsPackYearYear">Standard Rooms</label>
		<?php //echo $this->Form->input('GpsPack.standard_rooms', array('type' => 'text', 'label'=>false,'value'=>@$gps_settings['GpsSetting']['standard_rooms'])); ?>
	</div>
        <div class="input">
		<label for="GpsPackYearYear">Executive Rooms</label>
		<?php //echo $this->Form->input('GpsPack.executive_rooms', array('type' => 'text', 'label'=>false,'value'=>@$gps_settings['GpsSetting']['executive_rooms'])); ?>
	</div>
        <div class="inpu">
		<label for="GpsPackYearYear">Deluxe Rooms</label>
		<?php //echo $this->Form->input('GpsPack.deluxe_rooms', array('type' => 'text', 'label'=>false,'value'=>@$gps_settings['GpsSetting']['deluxe_rooms'])); ?>
	</div>
        <div class="input">
		<label for="GpsPackYearYear">Suites</label>
		<?php //echo $this->Form->input('GpsPack.suites_rooms', array('type' => 'text', 'label'=>false,'value'=>@$gps_settings['GpsSetting']['suites_rooms'])); ?>
	</div>-->
