...
<?php echo $this->Form->create('GpsPack', array('url' => array('prefix' => 'admin', 'admin' => true, 'controller' => 'GpsPacks', 'action' => 'add')));?>
    ...
    if(!empty($stepOldData)){
        header('Location: /admin/GpsPacks/edit/'.$step.'/'.$gps_pack_id);
    }
...
<!--                            <td>Av. Spend</td>-->
                ...
                <?php }elseif($step=='10'){ ?>
                    ...
                    <!-- Autofill-->
                   <?php header('Location: /admin/GpsPacks/add/14/'.$gps_pack_id); ?>
...
//                        $direct_arr['3'] = 'Walkin';
 		...
 		<legend><?php __('Prov Year'); ?></legend>
                ...
                <?php }elseif($step=='19'){ ?>
                    ...
                    <!-- Autofill-->
                    <?php header('Location: /admin/GpsPacks/add/20/'.$gps_pack_id); ?>
                <?php }elseif($step=='20'){ ?>
                    <table style="width:100%">
