                        ...
                        foreach($gpsPackSteps as $step_id=>$gps_step){ 
                            ...
                            <tr  style="<?php echo $style; ?>">
                                ...
                                <td class="sheetIndex buttonscol">
                                        <?php echo $this->Html->link('Edit', array('prefix' => 'staff', 'staff' => true, 'controller' => 'GpsPacks', 'action' => 'edit',$step_id,$GpsPack['GpsPack']['id']), array('class' => '', 'escape' => false,'style'=>'padding-bottom:5px;*line-height: 28px;')); ?>
                                </td>
                            </tr>
                       <?php $i++; } ?>
                    </tbody>
