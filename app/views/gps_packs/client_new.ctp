...
<div class="control-group">
	<div class="page-header position-relative">
                <h1>Hote; <small><i class="icon-double-angle-right"></i> Add GPS Pack</small></h1>
        </div>
        ...
        <div class="widget-body">
             <div class="widget-main">
                <div class="row-fluid">
<?php echo $this->Form->create('GpsPack', array('url' => array('prefix' => 'client', 'client' => true, 'controller' => 'GpsPacks', 'action' => 'new')));?>
...
?>
	...
	<?php
        ...
        echo "&nbsp;&nbsp;";
        echo $this->Html->link('Cancel', array('prefix' => 'client', 'client' => true, 'controller' => 'GpsPacks', 'action' => 'index',$client_id), array('class' => 'btn btn-success', 'escape' => false));
        echo $this->Form->end();
        ?>
        </div></div></div></div>
</div>