...
$(function() {
   $('#hotel_id').change(function() {
       ...
       window.location = '/client/GpsPacks/steps/' + parent_hotel_id+'/'+val;
    });
});
</script>
                    ...
                    <tbody>
                            <tr>
                                    <td class="sheetIndex buttonscol">
                                            <?php echo $this->Html->link("GPS Pack", array('prefix' => 'client', 'client' => true, 'controller' => 'GpsPacks', 'action' => 'index', $client_id), array('escape' => false,'class'=>'btn btn-info')); ?>
                                    </td>
                            </tr>
                    </tbody>
        	</table>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="sheetIndex buttonscol">
                                    <?php echo $this->Html->link('Assign User', array('prefix' => 'client', 'client' => true, 'controller' => 'GpsPacks', 'action' => 'assign',$user['User']['id'],$client_id), array('class' => '', 'escape' => false,'style'=>'padding-bottom:5px;*line-height: 28px;')); ?>
                                </td>
                            </tr>
                       <?php } 
                       } ?>
