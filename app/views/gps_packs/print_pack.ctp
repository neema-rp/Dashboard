...
$step1Display = ''; $step2Display = ''; $step3Display = ''; $step4Display = '';
$step5Display = ''; $step6Display = ''; $step7Display = ''; $step8Display = '';
$step9Display = ''; $step10Display = ''; $step11Display = ''; $step12Display = '';
$step13Display = ''; $step14Display = ''; $step15Display = ''; $step16Display = '';
$step17Display = ''; $step18Display = ''; $step19Display = ''; $step20Display = '';
$step21Display = ''; $step22Display = '';
    ...
    if($gps_settings['GpsSetting']['access_steps'] != 'ALL'){
        ...
        if($step == '5' || $step == '6' || $step == '7' || $step == '8'){ 
            if(!in_array('5-8',$gps_steps_ids)){
                 echo '<script>$(document).ready(function(){ $("#'.$divId.'").hide(); });</script>';
            }
        }if($step == '10' || $step == '11' || $step == '12' || $step == '13'){ 
            if(!in_array('10-13',$gps_steps_ids)){
                 echo '<script>$(document).ready(function(){ $("#'.$divId.'").hide(); });</script>';
            }
...
//echo '/GpsPacks/get_webform_monthly_score/'.$client_id.'/62/'.$financial_month.'/'.$year; exit;
...
for($month=$financial_month_start;$month <= ($financial_month_start + 11); $month++){
    $useMonthArr[$month] = $month > '12' ? $month - '12' : $month;
}

for($month=$financial_month_start;$month <= ($financial_month_start + 11); $month++){ 
    if($month > '12' && ($financial_month_start > $month)){
        $useYearArr[$month] = $year+'1';
     }else{
         $useYearArr[$month] = $year;
         if(array_search($useMonthArr[$month], $useMonthArr) < array_search($gps_month, $useMonthArr)){
            $useYearArr[$month] = $year-'1';
         }
     }
     $useYearArr[$month] = substr($useYearArr[$month],-2);
}
...
$config_html = '<div id="config_div">
                        ...
                        <tr>
                            <td colspan="2">&nbsp;</td>';
                            for($month=$financial_month_start;$month <= ($financial_month_start + 11); $month++){
                               $config_html .= '<td class="bold">'.date("M", mktime(0, 0, 0, $month, 1)).'-'.$useYearArr[$month].'</td>';
                              }
                        $config_html .= '</tr>';
                   ...
                   <div id="summary_div" >
                        <table class="table table-striped table-bordered table-hover">
                            <tr>
                               ...
                               <td class="bold"> <?php echo date("M", mktime(0, 0, 0, $month, 1)).'-'.$useYearArr[$month];  ?></td>
                                <?php } ?>
...
//                                        }
 		...
 		<legend><?php __('Market'); ?></legend>
                ...
                <fieldset id="divStep4">
 		<legend><?php __('Competitor Activity'); ?></legend>
