...
?>
<?php echo $this->Form->create('GpsPack', array('url' => array('prefix' => 'staff', 'staff' => true, 'controller' => 'GpsPacks', 'action' => 'edit')));?>
    ...
    ?>    
                ...
                <?php if($step=='1'){ 
                    ...
                    if(empty($step1Data)){
                        header('Location: /staff/GpsPacks/add/1/'.$gps_pack_id);
                    }
 		...
 		<legend><?php __('GM Summary'); ?></legend>
                ...
                <?php }elseif($step=='2'){ 
                    ...
                    if(empty($step2Data)){
                        header('Location: /staff/GpsPacks/add/2/'.$gps_pack_id);
                    }
                ?>
                <fieldset>
 		<legend><?php __('Summary'); ?></legend>
                ...
                <?php }elseif($step=='3'){ 
                    ...
                    if(empty($step3Data)){
                        header('Location: /staff/GpsPacks/add/3/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Market'); ?></legend>
                ...
                <?php }elseif($step=='4'){ 
                    ...
                    if(empty($step4Data)){
                        header('Location: /staff/GpsPacks/add/4/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Competition'); ?></legend>
                ...
                <?php }elseif($step=='5' || $step=='6' || $step=='7' || $step=='8'){
                    ...
                    if(empty($stepActData)){
                        header('Location: /staff/GpsPacks/add/'.$activity_month.'/'.$gps_pack_id);
                    }
 		...
 		<legend><?php __('Activity'); ?>&nbsp;<?php echo date("F", mktime(0, 0, 0, $activity_month, 1));  ?></legend>
                ...
                <?php }elseif($step=='9'){ 
                    ...
                    if(empty($step9Data)){
                        header('Location: /staff/GpsPacks/add/9/'.$gps_pack_id);
                    }
                    ?>
               <fieldset>
...
<!--                            <td class="bold">Av. Spend</td>-->
 		...
 		<legend><?php __('Market Segmentation - '); ?><?php echo date("F", mktime(0, 0, 0, $gps_month, 1));  ?></legend>
                <?php header('Location: /staff/GpsPacks/edit/14/'.$gps_pack_id); ?>
                </fieldset>
                <?php }elseif($step=='11'){ ?>
                <fieldset>
                <?php header('Location: /staff/GpsPacks/edit/14/'.$gps_pack_id); ?>
 		...
 		<legend><?php __('BOB - '); ?><?php echo date("F", mktime(0, 0, 0, ($gps_month+3), 1));  ?></legend>
                ...
                <?php }elseif($step=='14'){ 
                    ...
                    if(empty($step14Data)){
                        header('Location: /staff/GpsPacks/add/14/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
...
//                        $direct_arr['3'] = 'Walkin';
                ...
                <?php }elseif($step=='15'){ 
                    ...
                    if(empty($step15Data)){
                        header('Location: /staff/GpsPacks/add/15/'.$gps_pack_id);
                    }
                    ?>
               <fieldset>
...
//                        $direct_arr['3'] = 'Walkin';
                ...
                <?php }elseif($step=='16'){ 
                    ...
                    if(empty($step16Data)){
                        header('Location: /staff/GpsPacks/add/16/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Geo Year'); ?></legend>
                ...
                <?php }elseif($step=='17'){ 
                    ...
                    if(empty($step17Data)){
                        header('Location: /staff/GpsPacks/add/17/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Prov Year'); ?></legend>
                ...
                <?php }elseif($step=='18'){ 
                    ...
                    if(empty($step18Data)){
                        header('Location: /staff/GpsPacks/add/18/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		...
 		<legend><?php __('Room Type Year'); ?></legend>
                ...
                <?php header('Location: /staff/GpsPacks/edit/20/'.$gps_pack_id); ?>
                
                </fieldset>
                <?php }elseif($step=='20'){
                    $step20Data = $this->requestAction('/GpsPacks/get_gps_data/'.$gps_pack_id.'/20'); 
                    if(empty($step20Data)){
                        header('Location: /staff/GpsPacks/add/20/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Future Activity'); ?></legend>
                ...
                <?php }elseif($step=='21'){
                    ...
                    if(empty($step21Data)){
                        header('Location: /staff/GpsPacks/add/21/'.$gps_pack_id);
                    }
                    ?>
                <fieldset>
 		<legend><?php __('Reputation'); ?></legend>
              ...
              <?php }elseif($step=='22'){ 
                  ...
                  if(empty($step22Data)){
                        header('Location: /staff/GpsPacks/add/22/'.$gps_pack_id);
                    }
                  ?>
                <fieldset>
