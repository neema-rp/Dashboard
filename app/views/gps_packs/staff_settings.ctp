...
$(document).ready(function(){
        $(".chzn-select").chosen();
	$("#GpstaffAddForm").validationEngine();
...
<div class="control-group">
	<div class="page-header position-relative">
                <h1>Hotel <small><i class="icon-double-angle-right"></i> GPS Pack</small></h1>
        </div>
        ...
        <div class="widget-body">
            ...
            <?php echo $this->Form->create('GpsPack', array('url' => array('prefix' => 'staff', 'staff' => true, 'controller' => 'GpsPacks', 'action' => 'settings')));?>
	...
	<div class="input text required">
		...
		<?php
               ...
               // print_r($geo_list_ids);
                
                    echo $this->Form->input('province_list', array('multiple' => "multiple",'style' => "height:200px", 'div' => false, 'label' => 'Select Prov Year Provinces','class'=>'validate[required] span6 chzn-select','options'=>$geoLists,'value'=>$geo_list_ids));
		?>
	</div>
