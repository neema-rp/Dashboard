...
function print_report(){
    ...
    WinPrint.document.write('<link rel="stylesheet" type="text/css" href="https://beta.myrevenuedashboard.net/css/bootstrap.min.css" />');
    WinPrint.document.write('<link rel="stylesheet" type="text/css" href="https://beta.myrevenuedashboard.net/css/ace.min.css" />');
    WinPrint.document.write('<link rel="stylesheet" type="text/css" href="https://myrevenuedashboard.net/css/calander.css" />');
