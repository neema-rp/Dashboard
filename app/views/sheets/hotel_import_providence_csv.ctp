...
<div class="sheets index">
        <?php echo $this->Form->create('Sheet', array('url'=>array('controller'=>'sheets', 'action'=>'hotel_import_providence_csv/'.$clientId),'type' => 'file'));?>
        <fieldset>
            <legend><?php echo $hotelname; ?><?php __(' - Import CSV');?> </legend>
