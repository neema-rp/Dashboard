...
<?php echo $this->Form->create('Sheet', array('url' => array('controller' => 'sheets', 'action' => 'staff_copy_column' ,$sheetId)));?>
 ...
 <?php
    ...
    echo "&nbsp;&nbsp;";
    echo $this->Html->link('Cancel', array('prefix' => 'staff', 'staff' => true, 'controller' => 'sheets', 'action' => 'index'), array('class' => 'btn btn-success', 'escape' => false));
    echo $this->Form->end();
?>
