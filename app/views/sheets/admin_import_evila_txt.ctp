...
<div class="sheets index">
        <?php echo $this->Form->create('Sheet', array('url'=>array('controller'=>'sheets', 'action'=>'admin_import_evila_txt/'.$sheetId),'type' => 'file'));?>
        <fieldset>
        <legend><?php __('Text File Import');?></legend>
