...
function get_pickup_chart(){
       ...
       $('#pickup_chart_area').html('<div style="text-align:center;">Loading Please wait....</div>');
        ...
        $.post( 
             "/clients/get_pickup_chart_weekly/"+client_id+"/"+pickup_date+"/"+month+"/"+year,
             { name: "Zara" },
             function(data) {
...
function get_adr_pickup_chart(){
    ...
    function get_chart(client_id){
       ...
       $('#chart_area').html('<div style="text-align:center;">Loading Please wait....</div>');
        ...
        $.post( 
             "/clients/get_chart/"+client_id+"/"+hotel_month+"/"+hotel_year,
             { name: "Zara" },
             function(data) {
...
<div class="admins index" style="border-left:0 none;width:100%;">
...
//            $pickup_revenue = str_replace(",", "", $Sheetdata_today["Revenue"]) -  str_replace(",", "", $SheetdataDetails["Revenue"]);
            ...
            ?>
                ...
                <tr>
                <td><b>ADR</b></td>
                <td><?php echo $Sheetdata_today["ADR F'cst"]; ?></td>
                <td><?php echo $SheetdataDetails["ADR F'cst"]; ?></td>
                </tr>
                <tr>
                <td><b>RevPAR</b></td>
...
function print_report(){
    ...
    WinPrint.document.write('<br/>Notes:');
