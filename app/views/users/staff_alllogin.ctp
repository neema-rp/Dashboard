<div class="widget-body">
    ...
    <div class="space-6"></div>
        <?php echo $this->Form->create('User', array('url' => array('prefix' => 'staff', 'staff' => true,'controller' => 'users' ,'action' => 'alllogin'))); ?>
        <fieldset>
                <label>
    ...
    <div class="toolbar clearfix">
        <div>
            ...
            <?php //echo $this->Html->link("Login As Hotel?",array('controller' => 'clients', 'action' => 'login', 'client'=>false),array('style'=>'color:#ccc;')); ?> 
            
<!--            <a href="/users/forget_password" class="forgot-password-link">
