    ...
    <div class="span12">
        <div class="profile-user-info profile-user-info-striped">
                <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">&nbsp;<?php echo $this->Html->link($user['Client']['username'], array('controller' => 'clients', 'action' => 'view', $user['Client']['id'])); ?></div>
                </div>
        </div>
        <div class="profile-user-info profile-user-info-striped">
                <div class="profile-info-row">&nbsp;
			      ...
			      {
				if($dept['department_id'] == $this->params['pass'][1]){
