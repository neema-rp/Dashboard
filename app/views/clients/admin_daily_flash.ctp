...
<?php echo $this->Form->create('DailyFlash', array('url'=>array('controller'=>'clients', 'action'=>'admin_daily_flash')));?>
...
<?php 
    ...
    echo $this->Form->end();
    echo '&nbsp;&nbsp;';
    echo $this->Html->link('Cancel', array('prefix' => 'admin', 'admin' => true, 'controller' => 'clients', 'action' => 'index'), array('class' => 'btn btn-danger', 'escape' => false));
