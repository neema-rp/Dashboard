...
<div class="control-group">
	<div class="page-header position-relative">
            ...
            <a href="/client/clients/daily_flash/<?php echo $clientId; ?>"><button class="btn btn-info">Input Today's Flash Data<i class="icon-arrow-right  icon-on-right"></i></button></a>
            ...
            <?php echo $this->Form->create('DailyFlash', array('url'=>array('controller'=>'clients', 'action'=>'client_flash',$clientId)));?>
        ...
        <table>
            <?php if(!empty($unverifiedFlash)){ 
                ...
                <tr><td><a href="/c/clients/daily_flash/<?php echo $clientId; ?>/<?php echo $flash_veri['DailyFlash']['date']; ?>/<?php echo $flash_veri['DailyFlash']['id']; ?>"><?php echo $flash_veri['DailyFlash']['date']; ?></a></td></tr>
            <?php } }else{ ?>
