...
<div style="float:left;">
    <?php echo $this->Html->link('Close', array('prefix' => 'client', 'client' => true, 'controller' => 'clients', 'action' => 'index'), array('class' => 'btn btn-danger', 'escape' => false));?>
    <?php echo $this->Html->link('Download PDF', array('prefix' => 'client', 'client' => false, 'controller' => 'clients', 'action' => 'flash_pdf',$flashData['DailyFlash']['client_id'],$flashData['DailyFlash']['id']), array('class' => 'btn btn-primary', 'escape' => false));?>
