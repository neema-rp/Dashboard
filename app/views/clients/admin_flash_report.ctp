...
<div style="float:left;">
    <?php echo $this->Html->link('Close', array('prefix' => 'admin', 'admin' => true, 'controller' => 'clients', 'action' => 'index'), array('class' => 'btn btn-danger', 'escape' => false));?>
    <?php echo $this->Html->link('Download PDF', array('prefix' => 'admin', 'admin' => false, 'controller' => 'clients', 'action' => 'flash_pdf',$flashData['DailyFlash']['client_id'],$flashData['DailyFlash']['id']), array('class' => 'btn btn-primary', 'escape' => false));?>
    <?php //echo $this->Html->link('Verify & Submit', array('prefix' => 'admin', 'admin' => false, 'controller' => 'clients', 'action' => 'flash_verified',$flashData['DailyFlash']['client_id'],$flashData['DailyFlash']['id']), array('class' => 'new_button', 'escape' => false,'style'=>'padding-bottom:5px;*line-height: 28px;'));?>
</div>
</div>